...
const Page = () => {
    ...
    const handleSubmit = async (event: any) => {
        event.preventDefault();
        // Nobox was used here
        // const insertedData = await PostModel.find({
        //     ...blogData,
        //     id: "hey"
        // } as any);
        // console.log({ insertedData }); // console.log(blogData);

        // const returnedData = await PostModel.findOne({ id: insertedData.id });
        // console.log('Got post from Db with that id:', returnedData);

        // const id = insertedData.id;

        // setTimeout(() => {
        //     const updatedData = PostModel.updateOneById(id, { title: "You changed me" })
        //     console.log({ updatedData })
        // }, 300000);
